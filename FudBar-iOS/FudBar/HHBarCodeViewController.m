...
- (void)viewDidLoad {
    ...
    [self.cancelButton setTitleColor:self.labelTextColor forState:UIControlStateNormal];
    [self.cancelButton setTitle:@"Cancel" forState:UIControlStateNormal];
    [self.cancelButton setBackgroundColor:self.labelBackgroundColor];
    ...
    if ([self.device hasTorch]) {
        ...
        [self.flashButton setTitleColor:self.labelTextColor forState:UIControlStateNormal];
        [self.flashButton setTitle:@"Flash" forState:UIControlStateNormal];
        [self.flashButton setBackgroundColor:self.labelBackgroundColor];
